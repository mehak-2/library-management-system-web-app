    ...
    <div id="home">
        ...
        <div class="login-form section text-center">
            <div class="container">
                <h4 class="rad-txt">
                    ...
                    <span class="abtext">ADD BOOK</span>
                </h4>
                  <%
                                   if(request.getParameter("savebtn")!=null)
        {
            ...
            try
            {
                ...
                try
                {
                    PreparedStatement mystatement = myconnection.prepareStatement("insert into book (bookid,bookname,publisher,price,category1,publishyear) values(?,?,?,?,?,?)");
    ...
    %>
     ...
     <div id="loginbox" style="margin-top:30px;" class="mainbox  loginbox">
                        ...
                        <div class="form-group">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" id="category1" name="category1" placeholder="CATEGORY" required="">
                                    </div>
                                </div>
              ...
              <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="number" class="form-control" name="publishyear" placeholder="PUBLISH YEAR" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="signup-btn" style="margin-left: 60px;">
                                        <input id="btn-signup"  type="submit" class="btn btn-info" name="savebtn" value="ADD BOOK">
