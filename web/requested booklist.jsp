            ...
            <div class="container">
                <div class="row">
                    <ul class="btn-group btn-breadcrumb bc-list">
                        ...
                        <li class="btn btn2">
                            <a href="login.jsp">REQUEST BOOK SECTION</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="login-form section text-center">
            <div class="container">
                <h4 class="rad-txt">
                    ...
                    <span class="abtext">Requested Book's List</span>
                </h4>
              ...
              <div class='col-md-4 contact-right'>
               <div class='input-grids'>
                ...
                <select name="bookname" id="bookname" class="form-control">
                    <option value="">Choose Bookname</option>
                    ...
                    try {
                        ...
                        PreparedStatement mystatement = myConnection.prepareStatement("SELECT DISTINCT bookname FROM requestbook");
                        ResultSet myresult = mystatement.executeQuery();

                        while (myresult.next()) {
                            out.print("<option>" + myresult.getString("bookname") + "</option>");
                        }
                    } catch (Exception e) {
