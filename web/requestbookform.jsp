    ...
    <div id="home">
            ...
            <div class="container">
                <div class="row">
                    <ul class="btn-group btn-breadcrumb bc-list">
                        ...
                        <li class="btn btn2">
                            <a href="login.jsp">Request Book's Section</a>
                        </li>
                    </ul>
                </div>
            </div>
       ...
       <!-- signin and signup form -->
        <div class="login-form section text-center">
            <div class="container">
                <h4 class="rad-txt">
                    ...
                    <span class="abtext">REQUEST BOOK </span>
                </h4>
                                   ...
                                   if(request.getParameter("savebtn")!=null)
        {
            ...
            String rollno1,email1,fname1,gender1,course1,courseyear1,phone1,address1,bookname1;
            ...
            try
            {
                ...
                try
                {
                    PreparedStatement mystatement = myconnection.prepareStatement("insert into requestbook (rollno,email,fullname,gender,course,courseyear,phone,address,bookname) values(?,?,?,?,?,?,?,?,?)");
                    ...
                    mystatement.setString(9, bookname1);
                 
                    if(mystatement.executeUpdate()>0)
                    {
                        out.print("Request Sended successfully");
                    }
                    else
                    {
             ...
             <select name="courseyear" class="form-control" id='courseyear' required="">
              ...
              <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                      ...
                                      <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Request Book Name</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                    ...
                                    <div class="signup-btn">
                                        <input id="btn-signup"  type="submit" class="btn btn-info" name="savebtn" value="Send Request">
