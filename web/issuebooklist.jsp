            ...
            <div class="container">
                <div class="row">
                    <ul class="btn-group btn-breadcrumb bc-list">
                        ...
                        <li class="btn btn2">
                            <a href="login.jsp">ISSUE's BOOK SECTION</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="login-form section text-center">
            <div class="container">
                <h4 class="rad-txt">
                    ...
                    <span class="abtext">Issue Book List</span>
                </h4>
               ...
               <div class='input-grids'>
                 ...
                 <form method="get">
                    ...
                    try {
                        ...
                        PreparedStatement mystatement = myConnection.prepareStatement("SELECT DISTINCT(category) FROM issuebook");
                        ResultSet myresult = mystatement.executeQuery();
                        if(myresult.next()){
                            do{
                            out.print("<option>" + myresult.getString("category") + "</option>");
